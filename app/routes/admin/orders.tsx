...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-ranch-cream font-display">Orders</h1>
        ...
        >
          ...
          >
            <div className="flex justify-between items-start mb-6">
              <div>
                <h2 className="text-2xl font-bold text-ranch-cream font-display">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-ranch-cream mb-2 font-display">Customer</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-ranch-cream mb-2 font-display">Shipping</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-ranch-cream mb-2 font-display">Order Total</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-ranch-cream mb-2 font-display">Status</h3>
