  ...
  return (
    <div className="min-h-screen bg-ranch-dark py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-ranch-cream mb-2">
            🏆 Leaderboards
          </h1>
        ...
        >
          <h2 className="text-2xl font-bold text-ranch-cream mb-4 text-center">
                ...
                >
                  ...
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="text-ranch-cream font-semibold">
                        {entry.username}
                      </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <div className="text-xl font-bold text-ranch-lime">
                        {entry.score} pts
                      </div>
          ...
          {/* Footer message */}
          <div className="mt-6 text-center text-sm text-ranch-lavender">
