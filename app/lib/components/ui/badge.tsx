...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-base font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-ranch-lime focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
