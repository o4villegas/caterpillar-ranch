...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-base text-ranch-cream/70", className)}
    {...props}
  />
))
